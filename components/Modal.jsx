...
const Modal = ({ isOpen, onClose, winningAmount }) => {
    ...
    <div className={`fixed z-50 inset-0 overflow-y-auto ${isOpen ? '' : 'hidden'}`}>
      <div className="flex items-center justify-center min-h-screen">
        ...
        <div className="relative bg-white w-80 rounded-md shadow-lg" onClick={handleModalClick}>
          <div className="p-6">
            <h2 className="text-lg font-medium mb-2">Winning Amount</h2>
            <p className="text-2xl font-bold text-green-600">Your Winning Amount is {winningAmount}</p>
          </div>
